...
{
    public partial class TechnicalPrefrences : Form
    {
        ...
        private void Employees_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            frmManagement.menWindows.DropDownItems["menTechnicalDepartmentWindowsPrefrences"].Dispose();
        }
